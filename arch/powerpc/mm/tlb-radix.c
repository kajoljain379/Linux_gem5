...
static void exit_flush_lazy_tlbs(struct mm_struct *mm)
{
	...
	#else		
	// Exactly what mm_reset_thread_local does just the PROCESSOR ID is 0.
...
// Get this function out of the scope of CONFIG_SMP as some functions depend upon it evne when SMP is disabled
// static void exit_flush_lazy_tlbs(struct mm_struct *mm)
// {
// 	/*
// 	 * Would be nice if this was async so it could be run in
...
// Take this out of the SMP specific so that UP can also use it with conditional compilation
// static void __flush_all_mm(struct mm_struct *mm, bool fullmm)
// {
// 	unsigned long pid;
